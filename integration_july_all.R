...
## To work this out later  ## Point is to include NA values in the filter condition
...
fin_mw <- append_other_info(phy_ieq_mw_f)
write.csv(fin_mw,na="",'C:\\Users\\karthik\\Google Drive\\GSA DATA\\Data integration\\july_integration\\data_wb2_mw.csv')

fin_min <- append_other_info(phy_ieq_min_f)
write.csv(fin_min,na="",'C:\\Users\\karthik\\Google Drive\\GSA DATA\\Data integration\\july_integration\\data_wb2_min.csv')
